...
public class Log {
	...
	public static void ReceivedMessage(String source, BytesMessage message) throws JMSException {
		SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
		String timestamp = formatter.format(new Date());
		System.out.println(timestamp + " Bytes message received from: " + source + ". Message size: " + message.getBodyLength() + " bytes");
	}
